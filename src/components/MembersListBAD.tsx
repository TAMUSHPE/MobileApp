...
const MembersListBAD: React.FC<MembersProps> = ({ navigation, handleCardPress, officersList, membersList, loadMoreUsers, hasMoreUser, filter, setFilter, setLastUserSnapshot, canSearch, numLimit, setNumLimit, loading, DEFAULT_NUM_LIMIT = 10 }) => {
