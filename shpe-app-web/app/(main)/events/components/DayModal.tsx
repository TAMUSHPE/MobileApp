                            ...
                            return (
                                <div key={event.id} className="flex bg-red-300 rounded-lg text-center font-medium p-1">
                                    <div className="flex flex-col items-start w-full text-black ml-6">
                                        ...
                                        <p className="text-sm ml-4">{format(event.startTime!.toDate(), 'h:mm aaa')} - {format(event.endTime!.toDate(), 'h:mm aaa')}</p>
                                    </div>
                                </div>
                            )
                        })}
                    </div>
                    <button onClick={hide} className="absolute left-5 bg-[#500000] text-white text-sm font-semibold rounded-md p-2">
